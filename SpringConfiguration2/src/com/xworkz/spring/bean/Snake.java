...
public class Snake {
	...
	public Snake(@Qualifier("snakeName") String name, @Qualifier("snakeColor") String color,
			@Qualifier("snakeType") String type, @Qualifier("snakePoisionous") boolean poisionous) {
		super();
		this.name = name;
